...
1. You should see a banner with the message **2 members added**. Select **Done**, click on **Save** and then **Close**.
...
1. Enter **Holly** into the search field, select the Search icon on the right side of the field. 
...
1. This will initiate a search query that looks for the keywords **SSN**. Once the query is finished, wait for the preview results to be displayed.
